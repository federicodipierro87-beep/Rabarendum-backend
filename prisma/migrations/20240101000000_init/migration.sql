-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'JUROR');

-- CreateEnum
CREATE TYPE "Category" AS ENUM ('CARRI', 'GRUPPI', 'TENDINE', 'GUGGEN');
...
CREATE TABLE "User" (
    ...
    "name" TEXT NOT NULL,
    "role" "Role" NOT NULL DEFAULT 'JUROR',
...
-- CreateIndex
CREATE UNIQUE INDEX "Participant_name_category_key" ON "Participant"("name", "category");
